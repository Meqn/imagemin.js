...
(function (global, factory) {
	...
	function canvasToBlob(canvas, _ref) {
	  ...
	  return new Promise(function (resolve, reject) {
	    try {
	      if (canvas.toBlob) {
	        ...
	        var blob = dataURLtoFile(canvas.toDataURL(mimeType, quality), mimeType);
	        resolve(blob);
	      }
	    } catch (error) {
	      reject(error);
	...
	var Comporessor = /*#__PURE__*/function () {
	  function Comporessor(file, options) {
	    _classCallCheck(this, Comporessor);
	  ...
	  _createClass(Comporessor, [{
	    key: "init",
	    value: function () {
	      var _init = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee() {
	        var file, options, mimeType, data, arrBuffer, image;
	        return regenerator.wrap(function _callee$(_context) {
	          while (1) {
	            switch (_context.prev = _context.next) {
	              case 0:
	                file = this.file, options = this.options;
	              ...
	              case 8:
	                ...
	                _context.next = 16;
	                return filetoData(file, 'arrayBuffer');

	              case 16:
	                arrBuffer = _context.sent;
	              ...
	              case 24:
	                _context.next = 26;
	                return dataURLtoImage(data['url']);
	    ...
	    key: "compress",
	    value: function () {
	      var _compress = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2(canvas) {
	        var _this$options, quality, maxSize, mimeType, success, result, timer;
	        ...
	        return regenerator.wrap(function _callee2$(_context2) {
	          while (1) {
	            switch (_context2.prev = _context2.next) {
	              case 0:
	                _context2.prev = 0;
	                _this$options = this.options, quality = _this$options.quality, maxSize = _this$options.maxSize, mimeType = _this$options.mimeType, success = _this$options.success;
	                _context2.next = 4;
	    ...
	    key: "draw",
	    value: function draw(image, _ref) {
	      ...
	      var _this$resize = this.resize({
	        ...
	        size: size
	          ...
	          destWidth = _this$resize.destWidth,
	          destHeight = _this$resize.destHeight;
	      ...
	      switch (orientation) {
	        case 2:
	          ctx.transform(-1, 0, 0, 1, destWidth, 0);
	          break;

	        case 3:
	          ctx.transform(-1, 0, 0, -1, destWidth, destHeight);
	          break;

	        case 4:
	          ctx.transform(1, 0, 0, -1, 0, destHeight);
	          break;
	        ...
	        case 6:
	          ctx.transform(0, 1, -1, 0, destHeight, 0);
	          break;

	        case 7:
	          ctx.transform(0, -1, -1, 0, destHeight, destWidth);
	          break;

	        case 8:
	          ctx.transform(0, -1, 1, 0, 0, destWidth);
	          break;
	      }
	    ...
	    value: function resize(_ref2) {
	      ...
	      var _this$options2 = this.options,
	          maxWidth = _this$options2.maxWidth,
